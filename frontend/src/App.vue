  ...
  <div class="app-shell">
    ...
    <main>
      <aside class="workspace-panel">
        ...
        <hr />
        <h2>工具协议</h2>
        <ul class="tool-list"><li v-for="tool in metadata?.tools ?? []" :key="tool"><code>{{ tool }}</code><span>待实现</span></li></ul>
        <p class="muted">路径校验不等于系统沙箱。当前不会执行文件操作或 Shell。</p>

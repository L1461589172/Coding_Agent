...
本文件保留 M0 历史交付记录，其中“工具未实现”等表述指 M0 时点。此后 M1 已实现全部六个本地工具、D001 已修复，M2 Agent Runtime 已完整接入；当前全量 242 passed。工具契约见 [M1 工具系统完成说明](Coding%20Agent%20M1%20工具系统完成说明.md)，当前 M2 契约与验证见 [M2 上下文预算与 Agent Loop 说明](Coding%20Agent%20M2%20上下文预算与%20Agent%20Loop%20说明.md)。

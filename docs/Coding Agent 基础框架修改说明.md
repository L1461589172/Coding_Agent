...
本文件保留 M0 历史交付记录，其中“工具未实现”等表述指 M0 时点。当前 M1 已实现全部六个本地工具，D001 已修复，全量 194 passed，但默认 Runtime 仍未接入它们。工具契约见 [M1 工具系统完成说明](Coding%20Agent%20M1%20工具系统完成说明.md)，最新验证见 [D001 修复说明](Coding%20Agent%20D001%20修复说明.md)。

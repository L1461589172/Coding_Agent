...
本文件保留 M0 历史交付记录，其中“工具未实现”等表述指 M0 时点。此后 M1 六工具、M2 Runtime 与 M3 API/UI 已完整接入；当前全量 246 passed。工具契约见 [M1 工具系统完成说明](Coding%20Agent%20M1%20工具系统完成说明.md)，当前 UI/恢复契约见 [M3 API 与 UI 完成说明](Coding%20Agent%20M3%20API%20与%20UI%20完成说明.md)。

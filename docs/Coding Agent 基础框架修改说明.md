...
本文件保留 M0 历史交付记录，其中“工具未实现”等表述指 M0 时点。此后 M1–M4 已完整接入；当前全量 248 passed，真实 Demo 连续 3/3 成功。当前说明见 [M4 Demo 与可靠性完成说明](Coding%20Agent%20M4%20Demo%20与%20可靠性完成说明.md)。
